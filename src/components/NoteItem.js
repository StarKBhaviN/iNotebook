...
const NoteItem = (props) => {
  ...
  return (
    <div className='container col-md-4'>
      <div className="card my-3" style={{width : "18rem", backgroundColor : "#36494F", boxShadow : "0px 0px 5px pink", color : "#808080"}}>
          <div className="card-body">
            <div>
            <h5 className="card-title" style={{display : "inline-block", width : "190px", color : "#C0C0C0"}}>{note.title}</h5>
